...
# -*- coding: utf-8 -*-
"""
This is a script for converting the ModEM model format to the JSON model format

@author:  Maxim Smirnov  DREX GEO@2026
"""
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.plot_widget.setLabel('left', "mV/km, nT")
...
# --- NEW: Region of Interest (ROI) Object ---
    ...
    def load_selected_data_into_memory(self):
        ...
        for item in selected_items:
            ...
            try:
                ...
                if ('Data' in json_data and 'EB' in json_data['Data'] and
                    self.whattoplot in json_data['Data']['EB']):
                    comp_data = json_data['Data']['EB'][self.whattoplot]
    ...
    def refresh_plot(self):
        ...
        for file_path, data in self.active_data.items():
            ...
            var = np.array(data['var'], dtype=float)
            sigma = np.sqrt(var) * 2
    ...
    def save_changes_to_disk(self):
        ...
        try:
            for file_path, modified_data in self.active_data.items():
                ...
                target_block = full_json['Data']['EB'][self.whattoplot]
